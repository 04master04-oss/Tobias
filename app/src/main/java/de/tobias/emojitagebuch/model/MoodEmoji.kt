...
object MoodCatalog {
    ...
    val categories: List<MoodCategory> = listOf(
        cat(
            ...
            "🤣" to "Kaputtlachen", "😆" to "Ausgelassen", "🙌" to "Jubelnd", "💪" to "Stark",
        ),
        cat(
            "Gut", 4,
            "😊" to "Fröhlich", "😄" to "Lächelnd", "🙂" to "Zufrieden", "😌" to "Entspannt",
            "😇" to "Friedlich", "😋" to "Genießend", "🤭" to "Amüsiert", "😏" to "Selbstsicher",
            "🥲" to "Gerührt", "😉" to "Verschmitzt", "🧘" to "Ausgeglichen", "☺️" to "Wohlig",
        ),
        cat(
            "Okay", 3,
            "😐" to "Neutral", "😶" to "Sprachlos", "🤔" to "Nachdenklich", "😴" to "Müde",
            "🙄" to "Genervt", "😬" to "Angespannt", "🤷" to "Egal", "😑" to "Ausdruckslos",
            "🫤" to "Unschlüssig", "😮" to "Überrascht", "🥱" to "Gelangweilt", "🤒" to "Krank",
        ),
        cat(
            "Schlecht", 2,
            "😕" to "Verwirrt", "😟" to "Besorgt", "😔" to "Niedergeschlagen", "😢" to "Traurig",
            "😞" to "Enttäuscht", "😩" to "Erschöpft", "😰" to "Ängstlich", "🤧" to "Erkältet",
            "😣" to "Gequält", "😥" to "Bedrückt", "🥺" to "Verletzlich", "😓" to "Gestresst",
        ),
        cat(
            "Mies", 1,
            "😭" to "Weinend", "😡" to "Wütend", "🤬" to "Rasend", "😤" to "Frustriert",
            "😱" to "Panisch", "😫" to "Am Ende", "💔" to "Gebrochen", "🤢" to "Übel",
            "😖" to "Verzweifelt", "😠" to "Böse", "🤯" to "Überfordert", "😵" to "Fertig",
        ),
    )
